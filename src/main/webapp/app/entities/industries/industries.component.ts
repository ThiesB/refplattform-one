...
export class IndustriesComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: Industries) {
        return item.id;
    }
    registerChangeInIndustries() {
        this.eventSubscriber = this.eventManager.subscribe('industriesListModification', (response) => this.reset());
    }
